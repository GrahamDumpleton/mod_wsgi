# -*- coding: utf-8 -*-
#
# mod_wsgi documentation build configuration file, created by
...
def _version_info():
    ...
    return match.group('version').split('.')
...
latex_documents = [
  ('index', 'mod_wsgi.tex', u'mod\\_wsgi Documentation',
...
man_pages = [
    ('index', 'mod_wsgi', u'mod_wsgi Documentation',
...
texinfo_documents = [
  ('index', 'mod_wsgi', u'mod_wsgi Documentation',
   u'Graham Dumpleton', 'mod_wsgi', 'One line description of project.',
   'Miscellaneous'),
]
